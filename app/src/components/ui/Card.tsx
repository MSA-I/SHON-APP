...
export function Card({ children, hover = false, testId, onClick }: CardProps) {
  ...
  // Per SOP 09 §3 cards always have 24px (p-6) padding. Brief explicitly
  // requests 24px — single source of truth.
  return (
    <motion.div
      data-testid={testId}
